...
export declare type HabitDetailsUpdateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: HabitDetailsUpdateFormInputValues) => HabitDetailsUpdateFormInputValues;
    onSuccess?: (fields: HabitDetailsUpdateFormInputValues) => void;
    onError?: (fields: HabitDetailsUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: HabitDetailsUpdateFormInputValues) => HabitDetailsUpdateFormInputValues;
    onValidate?: HabitDetailsUpdateFormValidationValues;
} & React.CSSProperties>;
export default function HabitDetailsUpdateForm(props: HabitDetailsUpdateFormProps): React.ReactElement;
