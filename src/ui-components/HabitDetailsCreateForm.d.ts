...
export declare type HabitDetailsCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: HabitDetailsCreateFormInputValues) => HabitDetailsCreateFormInputValues;
    onSuccess?: (fields: HabitDetailsCreateFormInputValues) => void;
    onError?: (fields: HabitDetailsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: HabitDetailsCreateFormInputValues) => HabitDetailsCreateFormInputValues;
    onValidate?: HabitDetailsCreateFormValidationValues;
} & React.CSSProperties>;
export default function HabitDetailsCreateForm(props: HabitDetailsCreateFormProps): React.ReactElement;
