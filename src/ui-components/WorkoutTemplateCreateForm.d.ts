...
export declare type WorkoutTemplateCreateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: WorkoutTemplateCreateFormInputValues,
    ) => WorkoutTemplateCreateFormInputValues;
...
>;
export default function WorkoutTemplateCreateForm(
  props: WorkoutTemplateCreateFormProps,
): React.ReactElement;
