...
import { createActivityHabit } from '../graphql/mutations';
const client = generateClient();
export default function ActivityHabitCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setSessionsPerWeek(initialValues.sessionsPerWeek);
    setCompletedSessions(initialValues.completedSessions);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createActivityHabit.replaceAll('__typename', ''),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, 'ActivityHabitCreateForm')}
      {...rest}
    >
      <TextField
        label="Name"
