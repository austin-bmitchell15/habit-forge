...
export declare type GeneralHabitUpdateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: GeneralHabitUpdateFormInputValues) => GeneralHabitUpdateFormInputValues;
    onSuccess?: (fields: GeneralHabitUpdateFormInputValues) => void;
    onError?: (fields: GeneralHabitUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: GeneralHabitUpdateFormInputValues) => GeneralHabitUpdateFormInputValues;
    onValidate?: GeneralHabitUpdateFormValidationValues;
} & React.CSSProperties>;
export default function GeneralHabitUpdateForm(props: GeneralHabitUpdateFormProps): React.ReactElement;
