...
export declare type ActivityHabitUpdateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: ActivityHabitUpdateFormInputValues,
    ) => ActivityHabitUpdateFormInputValues;
...
>;
export default function ActivityHabitUpdateForm(
  props: ActivityHabitUpdateFormProps,
): React.ReactElement;
