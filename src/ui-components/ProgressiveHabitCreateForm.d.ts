...
export declare type ProgressiveHabitCreateFormProps = React.PropsWithChildren<
  {
    ...
    onSubmit?: (
      fields: ProgressiveHabitCreateFormInputValues,
    ) => ProgressiveHabitCreateFormInputValues;
...
>;
export default function ProgressiveHabitCreateForm(
  props: ProgressiveHabitCreateFormProps,
): React.ReactElement;
