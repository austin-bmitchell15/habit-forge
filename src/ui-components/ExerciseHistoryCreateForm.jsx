...
import { createExerciseHistory } from '../graphql/mutations';
const client = generateClient();
export default function ExerciseHistoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createExerciseHistory.replaceAll('__typename', ''),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, 'ExerciseHistoryCreateForm')}
      {...rest}
    >
      <TextField
        label="Sets"
